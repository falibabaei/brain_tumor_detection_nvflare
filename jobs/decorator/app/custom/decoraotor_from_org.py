...
def main():
    ...
    def evaluate(input_weights):
        ...
        with torch.no_grad():
            for data in testloader:
                ...
                correct += torch.sum(pred_labels == labels.data)
    ...
    while flare.is_running():
        ...
        print(
            f"Accuracy of the global model on the 10000 test images: {global_metric} %"
        )
        # call train method
        ...
        print(
            f"Accuracy of the trained model on the 10000 test images: {metric} %"
        )
