...
def create_dataset(data_split, img_dir, img_list, index, image_transform):
...
def load_data(data_split:dict, client_id:str, image_transform ):
        ...
        train_data = create_dataset(data_split["data_index"],img_dir ,img_list, client_id, image_transform)
        valid_data = create_dataset(data_split["data_index"], img_dir, img_list, "valid", image_transform)
...
if __name__=='__main__':
    ...
    with open(data_split_filename, "r") as file:
            data_split = json.load(file)
    train_data, vaid_data =  load_data(data_split, client_id, image_transform )   
